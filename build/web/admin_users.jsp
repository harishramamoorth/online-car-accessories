...
<div class="menu-wrap">
	<div class="menu">
		<ul>
            ...
            <li><a href="admin_users.jsp" class="active">Users</a></li>
                           ...
                           <table width="99%" border="0" align="center">
                            <%       
                                ...
                                while (rs0.next()) {
                                    if (s == 0) {
                            %>
                            <tr><td height="45" colspan="8"><div align="center">
                              <div align="center" class="style4">User Details  </div></td>
                             </tr>
                            <tr>
                                <td></td>
                              <td width="31" height="32"><h4 align="center" class="style1"><strong><span class="style2 style5 style7"><em>Id</em></span></strong></h4></td>
                                <td width="139"><h4 align="center" class="style7 style6 style3 style5"><strong>Name</strong></h4></td>
                                <td width="162"><h4 align="center" class="style6 style7 style3 style5"><strong><strong>Gender</strong></strong></h4></td>
                                
                                <td width="213"><h4 align="center" class="style7 style6 style3 style5"><strong>Contact</strong></h4></td>
                                <td width="185"><h4 align="center" class="style7 style6 style3 style5"><strong>Email</strong></h4></td>

                                <td width="162"><h4 align="center" class="style7 style6 style3 style5"><strong>Address</strong></h4></td>
