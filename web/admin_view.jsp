...
.style6 {font-size: 36px; color: #000000; font-weight: bold; }
...
<div class="menu-wrap">
	<div class="menu">
		<ul>
            ...
            <li><a href="admin_add.jsp">Add</a></li>
            <li><a href="admin_view.jsp" class="active">View</a></li>
                        ...
                        <p>&nbsp;</p>
                           ...
                           <table width="99%" border="0" align="center">
                            <%       
                                ...
                                ResultSet rs0 = stmt3.executeQuery("select * from acc ");
                                int s = 0;
                                while (rs0.next()) {
                                    if (s == 0) {
                            %>
                            <tr><td height="45" colspan="9"><div align="center">
                              <div align="center"><span class="text-danger style5 style4"><strong><strong><strong><strong>Sender Details  </strong></strong></strong></strong></span></div></td>
                             </tr>
                            <tr>
                                <td></td>
                              <td width="31" height="32"><h4 align="center" class="style1"><strong><span class="style7 style6 style4 style5"><em>Id</em></span></strong></h4></td>
                                <td width="139"><h4 align="center" class="style7 style6 style4"><strong>Accessory</strong></h4></td>
                                <td width="162"><h4 align="center" class="style6 style7 style4"><strong><strong>Price</strong></strong></h4></td>
                                
                                <td width="213"><h4 align="center" class="style7 style6 style4"><strong>Car Name</strong></h4></td>
                                <td width="185"><h4 align="center" class="style7 style6 style4"><strong>Model</strong></h4></td>

                                <td width="162"><h4 align="center" class="style7 style6 style4"><strong>Year</strong></h4></td>
                                <td width="162"><h4 align="center" class="style7 style6 style4"><strong>Date</strong></h4></td>
                                <td width="162"><h4 align="center" class="style7 style6 style4"><strong>Image</strong></h4></td>
								 <td width="162"><h4 align="center" class="style7 style6 style4"><strong>Delete</strong></h4></td>
                             <td></td>
                            </tr>
                            <%
                                }
                            ...
                            <tr>
                                ...
                                <td><div align="center" class="style8">
                                    ...
                                    <td><div align="center" class="style8">
                                            <img src="upload/<% out.print(rs0.getString("img")); %> " width="100" height="100" alt="">
                                        </div></td>    
                                        <td><div align="center" class="style8">
                                                    <a href="delete.jsp?id=1&fid=<% out.print(rs0.getString("id")); %>" class="style9">Delete</a>
                                      </div></td>
                                         <td></td>
                            </tr>
                            <%
